...
\frame
{
  ...
  \begin{tikzpicture}[
    ...
    \visible<5> {
    \node[maybefast,label=right:?] (javamaybefast) at (9,\javaopenjdktime*\phppatchtime/\phptime) {};
    \draw [maybe,->] (java) -- (javamaybefast);

    \node[maybefast,label=right:?] (golangmaybefast) at (11,\golangtime*\phppatchtime/\phptime) {};
