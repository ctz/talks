...
\frame
{
  ...
  \begin{tikzpicture}[
    ...
    \node (x0) [above=of h0] {$"hello"$};
    \node (x1) [above=of h1] {$"world"$};
    \node (final) [right=of h1] {$H("hello world")$};
    \draw [->] (init) -- (h0);
    \draw [->] (h0) -- (h1);
    \draw [->] (h1) -- (final);
    \draw [->] (x0) -- (h0);
...
\frame
{
  \frametitle{Intro: HMAC} \beginner
  ...
  \begin{tikzpicture}[
    ...
    \node[compf] (ho0) [below=7 of hi0] {h};
    \node[compf] (ho1) [below=7 of hi1] {h};
    ...
    \node (ki) [above=of hi0] {$key \oplus ipad$};
    \node (ko) [above=of ho0] {$key \oplus opad$};
...
\frame
{
  ...
  \begin{itemize}
    \item<2> Parametised with a PRF, usually HMAC.
...
\frame
{
  ...
  \begin{tikzpicture}[
    ...
    \node (salt) [left=3 of u1] {$salt\ \Vert\ 0_{32}$};
  ...
  {\footnotesize 
  \begin{align*}
    \text{PBKDF2}_\text{HMAC}(\text{pw}, \text{salt}, \text{i}) &\coloneqq U_1 \oplus U_2 \oplus \cdots \oplus U_\text{i} \\
    \text{where} \\
    U_1 &\coloneqq \text{HMAC}(\text{pw}, \text{salt}\ \Vert\ 0_{32}) \\
    U_n &\coloneqq \text{HMAC}(\text{pw}, U_{n-1}) \\
  \end{align*}
  }
...
\frame
{
  \beginner \frametitle{PBKDF2: quick intro}
...
\frame
{
  \beginner \frametitle{PBKDF2: how it was described}
